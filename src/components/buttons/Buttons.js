...
import { setMsgModalState, setNotification, setStartTransition } from "../store/reducers/userProfileSlice";
        ...
        <div className='favorites'>
            <span>
                { keyViewed && loginStatus ?
                    ...
                    <button 
                        ...
                        onClick={() => loginStatus ? (addViewedFilm(filmInfo), dispatch(setNotification('addViewed')), dispatch(setStartTransition(true))) : dispatch(setMsgModalState({display: 'block'}))}> 
            ...
            <span>
                { keyFavorite && loginStatus ? 
                    ...
                    <button 
                        className='btn-favorites'
                        onClick={() => loginStatus ? (addFavoriteFilm(filmInfo), dispatch(setNotification('addFavorite')), dispatch(setStartTransition(true))) : dispatch(setMsgModalState({display: 'block'}))}>
